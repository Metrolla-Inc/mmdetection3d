# Used https://github.com/supervisely-ecosystem/mmdetection_3d/blob/481803cd16a9d41b8e7bc1e2c19d9498be763cf0/train/src/sly_dataset.py#L106
# as a starting point
...
def outdoor_eval(gt_annos,
    ...
    for img_id in range(len(dt_annos)):
        ...
        if len(gt_anno['gt_bboxes_3d']) != 0:
            ...
            gt_labels_3d = []
            gt_names_3d = gt_anno['gt_names']
            for cat in gt_names_3d:
                gt_labels_3d.append(cat2label[cat])

            gt_labels_3d = np.array(gt_labels_3d)
            labels_3d = torch.from_numpy(gt_labels_3d) # can cause an error
        else:
            gt_boxes = box_type_3d(
...
class SOSDataset(Custom3DDataset):
    ...
    def evaluate(self,
        ...
        cat2label = {cat_id: i for i, cat_id in enumerate(self.CLASSES)}
